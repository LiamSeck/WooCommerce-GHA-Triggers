...
echo `date - GitHub Action Run ID: $GHA_RUN_NO` >> action-scheduler-run.log 2>> action-scheduler-run-error.log
# echo "GitHub Action Run ID: $GHA_RUN_NO" >> action-scheduler-run.log 2>> action-scheduler-run-error.log
echo `date - GitHub Action Run ID: $GHA_RUN_NO` >> cron-run.log 2>> cron-run-error.log
